...
local key_mappings = {
  ...
  { "<leader>cc",  "<cmd>ConjureConnect<cr>", desc = "Connect",
    nowait = false, remap = false },
  ...
  { "<leader>d",   group = "Debug", nowait = false, remap = false, desc = "Debug"},
  { "<leader>dc",  group = "clog(n)", nowait = false, remap = false },
  { "<leader>dcc", "<plug>(sexp_round_head_wrap_element)<cmd>lua insertClog()<cr><esc>w",
    desc = "Insert clog", nowait = false, remap = false },
  { "<leader>dcn", "<plug>(sexp_round_head_wrap_element)<cmd>lua insertClogn()<cr><esc>w",
    desc = "Insert clogn", nowait = false, remap = false },
  { "<leader>dd",  "<plug>(sexp_round_head_wrap_element)<cmd>lua insertDbg()<cr><esc>w",
    desc = "Insert dbg/clog", nowait = false, remap = false },
  { "<leader>dn",  "<plug>(sexp_round_head_wrap_element)<cmd>lua insertDbgn()<cr><esc>w",
    desc = "Insert dbgn/clogn", nowait = false, remap = false },
  { "<leader>dr",  "<plug>(sexp_raise_element)<cmd>lua removeDbg()<cr>",
    desc = "Remove dbg(n)/clog(n)", nowait = false, remap = false },
